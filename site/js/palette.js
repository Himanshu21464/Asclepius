...
(() => {
    ...
    const INDEX = [
        ...
        { title: 'Migrations — version-to-version', url: 'migrations.html',                     kind: 'page',    terms: 'migrations migrate upgrade version snapshot restore ml-dsa dual sign m-001 m-002 m-003 m-004' },
        ...
        { title: 'Tabletop — drift gaslighting',    url: 'threat-tabletop.html#tt-04',           kind: 'section', terms: 'tt-04 drift gaslight gradual shift psi' },
        { title: 'Tabletop — key leak',             url: 'threat-tabletop.html#tt-05',           kind: 'section', terms: 'tt-05 key leak hsm bypass compromise' },
        { title: 'Threat A7 — emergency-override abuse', url: 'threat-model.html#a7-emergency-override-abuse', kind: 'section', terms: 'a7 emergency override abuse break glass dpdp 72h backfill attestation falsification residual risk' },
        { title: 'Threat A8 — family-graph forgery',     url: 'threat-model.html#a8-family-graph-forgery',     kind: 'section', terms: 'a8 family graph forgery proxy subject minor guardian identity provider abdm' },
        { title: 'Regulator — DPDP Act &amp; ABDM (India)', url: 'regulator.html#dpdp-india',     kind: 'section', terms: 'dpdp digital personal data protection act 2023 abdm india national health authority hip hiu §06 emergency consent children erasure purpose taxonomy' },
        { title: 'Release — sign step',             url: 'release-process.html#sign',            kind: 'section', terms: 'sign pgp sigstore cosign verification' },
        { title: 'Release — advisory severity',     url: 'release-process.html#advise',          kind: 'section', terms: 'advisory severity critical high medium low cve disclosure' },
        { title: 'Migration M-001 — v0.0 → v0.1',     url: 'migrations.html#m-001',             kind: 'section', terms: 'migration m-001 0.0 0.1 initial ga genesis' },
        { title: 'Migration M-002 — snapshot &amp; restore',url: 'migrations.html#m-002',             kind: 'section', terms: 'migration m-002 snapshot restore sqlite copy ledger migrator' },
        ...
        { title: 'Playbook — emergency-override backfill overdue', url: 'playbooks.html#overdue-backfill', kind: 'section', terms: 'pb-08 emergency override backfill overdue dpdp 72h break-glass attest expired india' },
        ...
        { title: 'ADR-011 — Remove Postgres backend',url: 'decisions.html#adr-011',            kind: 'adr',     terms: 'adr 011 sqlite only single backend rip postgres removed v0.4.0' },
        { title: 'ADR-012 — On the name Asclepius', url: 'decisions.html#adr-012',            kind: 'adr',     terms: 'adr 012 name collision microsoft starmpcc dicoding asclepius-med oslabs blockchain disambiguation positioning' },
        { title: 'ADR-013 — India profile primitives', url: 'decisions.html#adr-013',         kind: 'adr',     terms: 'adr 013 india abdm consent artefact family graph emergency override hip hiu national health authority' },
        { title: 'ADR-014 — Purpose enum extension policy', url: 'decisions.html#adr-014',    kind: 'adr',     terms: 'adr 014 purpose enum extension governance preventive maternal chronic population care coordination billing' },
        { title: 'India profile (ABDM mapping)',    url: 'india.html',                        kind: 'page',    terms: 'india abdm ayushman bharat abha hip hiu emergency override family graph minor guardian dpdp digital health mission' },
        { title: 'L2-Medical conformance tier',     url: 'conformance.html#l2-medical',       kind: 'anchor',  terms: 'l2 medical conformance asclepius-med benchmark spectrum specialty fixture acl 2025' },
        { title: 'Integrations — Microsoft Asclepius wrap', url: 'integrations.html#ms-asclepius',    kind: 'anchor', terms: 'microsoft asclepius azure openai semantic kernel lab summary patient blazor function app §06' },
        { title: 'Integrations — starmpcc/Asclepius wrap', url: 'integrations.html#starmpcc-asclepius', kind: 'anchor', terms: 'starmpcc asclepius llama mistral discharge summary clinical llm hugging face mimic asclepius-r §07' },
        { title: 'Integrations — ABDM (India) primitives', url: 'integrations.html#abdm-india',         kind: 'anchor', terms: 'abdm india consent artefact family graph emergency override break glass dpdp 7 hip hiu gateway abha §08' },
...
{ title: 'Deploy guide (production)',     url: 'deploy.html',                       kind: 'page',    terms: 'deploy production docker compose sqlite sidecar kubernetes hsm key custody retention' },
